...
Page({
  data: {
    ...
    imageList: ["character", "sky_1_bg", "phoneticize", "strokeSequence", "evolution_01", "evolution_02", "evolution_03", "evolution_04", "evolution_05"],
  },

  onLoad: function (options) {
    const that = this;
    // that.innerAudioContext = wx.createAudioContext('audio-sky');
    that.setImageUrl("common", "details_sky_1")
  },
